...
def macro(documentevent=None):  # 引数は文書のイベント駆動用。  
	...
	interactionhandler = smgr.createInstanceWithContext("com.sun.star.task.InteractionHandler", ctx)  # サービス名か実装名でインスタンス化。
	propertyvalues = PropertyValue(Name="InteractionHandler", Value=interactionhandler),
